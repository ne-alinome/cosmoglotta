...
// A{dot} Meillet ha morit {{{2
=== A{dot} Meillet ha morit
...
// E{dot} de Wahl: Li developation de Occidental (Cronologic tabelle) {{{2
=== E{dot} de Wahl: Li developation de Occidental (Cronologic tabelle)
