...
continua propagar su sistema desde 1906 (27 annus!) publicante claves e mem un
...
asteriscos ({asterisk}) o crucettes ({cross}), quam in quelc printerías, e si on
...
{cross} (crucette) {equals} (in general:) mort in…; (in lingues:) arcaic,
obsolet.
...
// {cross} Dr. Arnold Schrag {{{2
=== {cross} Dr. Arnold Schrag
...
(Image: E. PIGAL, K. JANOTTA, E. DEMINGER, E. GRABER, {cross}{nbsp}HANS HOERBIGER,
