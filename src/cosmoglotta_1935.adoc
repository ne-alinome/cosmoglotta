...
//
// Last modified: 20241111T2200+0100.
...
// Gerald A. Moore {cross} {{{2
=== Gerald A. Moore {cross}
...
mundlingue quam li
monoglottes. Ma 1) just li poliglottes save que mem li apprension de 3
...
// {cross} Sr. Gerald A. Moore {{{2
=== {cross} Sr. Gerald A. Moore
...
-- Hat sentit solitá quam enoy e dolore {en_dash}
...
-- Ha in funde savet ni necos con se far {en_dash}
