...
=== Li anti-occidental ortografie in Esperanto{blank
...
unesim. Vide <<cgl_b44_standardisation, Standardisation in Cosmoglotta
B 44>>. Note del editor digital.]»; finition -issim.
...
omni esperantie, Vo qui intra), li correctet citate de Astralist nro 1
