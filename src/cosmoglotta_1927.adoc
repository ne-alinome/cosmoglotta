...
//
// Last modified: 20241111T1554+0100.
...
durant mult annus stant exter li activ movement, li autor de Occidental
...
fundamentes de Esperanto. Li Esperanto-presse quel durant mult annus ha
...
disvastigita: kaj tamen ĉiuj tiuj rezolucioj restis sur la papero de la
...
un contra li altris e omni adherentes ne posse adjunter se a ti quel have
...
omni international e absolut comun paroles es alterat, p. ex. tecnica {equals}
_kaen_, locomotive {equals} _lemüf_ etc. Quáncam Volapük hat existet ja 8 annus e
...
con conosset
radicas, Volapük devet fallir. Li principie de un
...
plu pri totmundan! Ma anc ti auxiliari lingue Esperanto havet li idé scrir
...
international paroles del tecnica, scientie, jure, economie, arte etc.
...
maturation posse exister solmen in li constant combatte inter li anteyan
e nov opinion.
...
Nu nequel de ti du combattes es ja finit.

Li question es: Esque li
...
caricat mem li max international paroles til ínreconossibilitá. Ti
ínreconossibilitá es augmentat ancor per li exonomisation in li
...
es comprensibil solmen a tis, queles comprende li respectiv lingue
...
scri: «Estas pruvita fakto ke precipe instruistoj ne favoras eĉ rifuzas
...
Esperanto-congresses e subtene li moventie. Li altris have visibilmen tre
...
til que it ne es plu reconossibil quam foren p. ex. F _boulevard_ de D
_Bollwerk_, D _Pferd_ de L _paraveredus_, R _Kulebäka_ de D _Kohlgebäck_, Est
_selts_ de D _Gesellschaft_, D _rist_ de R _krest_ etc.
...
nequalmen posse adaptar un parol quam D _Schraube_ al styl del lingue international e li
...
instincte revolta contra li ligation del romanic finition _o_ con german
...
- tecnica e industrie: germanic (scruv, muff, ersatz, vind, slitt,
...
Ma li paroles sol ne fa ancor un lingue. Ili es ligat per grammatica,
...
ex. Occidental usa formes quam _delegation, fiction, formation,_ ma Ido
_delegitaro, fiktiveso, formacuro,_ lingual images, conosset in ante de
...
p{dot} ex. li parol _fémina_ in Occidental plu ínmediatmen evoca li desirat
efecte che un italiano qui in su lingue matrin dí «femina», quam li
esperantic parol _virino_, quel va haver null resonantie, null
«espressivitá», malgré to que it es tre regularmen derivat de _viro_. Lu
sam vale anc por _delegitaro_ de Ido in vice de _delegation_, etc. Un
...
Partú u existe un special tecnica, existe un special idé _eo ipso_. Li
...
quam li ideale li devise: _un vorto -- un nociono; un nociono -- un
vorto_. Ma to es pur reva, e mem ne un bell reva, quel nequande es
...
monosemie, ma a polisemie (multisensitá), quo fa un grand númere de
...
Mecanic, rationalistic lingues quam Esperanto e Ido es basat sur
...
secun propri leges. Yo va citar quelc passages del interessant articul de Dr.
...
propri fonte … Quam viviplen es … _ano, aniĝi; aro, ariĝi; ema,
emi; ebla, ebligi; malebligi_ etc. … «la ĉina Esperanto» … Quande un
...
«Esperanta» quam li supra citat «China-Esperanto» li ver europan
...
Esperanto, omni ti _nepri_ (dever), _ree_ (denov), _laŭi_ (esser conform),
_malanigi_ (excluder), _iomete_ (un poc), _endas_ (deve esser fat), _eke_
(subit), _virino_ (femina), _estro_ (chef) etc. Ma just li «forenes» es
...
Nota. Si Th fini per _x, s, d_ (changeat in _s_) on adjunte solmen _o_.

Li finale _e_ del Th deveni curt _i_ in G.

_amar_ -- _amato_, _gemer_ -- _gémito_, ma _dicer_ -- dicto_, _vider_ -- _viso_,
_annexer_ -- _annexo_, _audir_ -- _audito_.

Do in li verbes _dicer, vider, annexer_ li Th ne es _dice, vide, annexe_ ma
_dic, vid, annex_, e in _gemer_ it ne es _gem_ ma _geme_. Regretabilmen li
estimat autor ne di nos qualmen un person ne-latinist va saver ca li _e_
apartene al Th o ne.
...
formes: _construcer, elecer, andjuncer, afflicer_, esque anc _fluxer_?
...
con li verbes L.: _tangere_ -- _tactum_, _creder_ esque _creso_? _rumpere_ -- _ruptum_
(_ruper_?) _posse_, _venire_ -- _ventum_, _nascere_ -- _natum_, _noscere_ -- _notum_,
_currere_ -- _cursum_, _fingere_ -- _fictum_, _fluere_ -- _fluxum_ (_fluxer_?),
_frangere_ -- _fractum_ (_fracer_?) _fundere_ -- _fusum_, _mergere_ -- _mersum_,
_movere_ -- _motum_, _mulgere_ -- _emulsion_, _pellere_ -- _pulsum_, _premere_ -- _pressum_,
_quaerere_ -- _quaesitum_, _adhaerere_ -- _adhaes-ion_, _scindere_ -- _scissum_,
_sidere_ -- _sess-ion_, _solvere_ -- _solutum_, _stringere_ -- _strictum_,
_terere_ -- _tritum_, _torquere_ -- _tortum_, _vivere_ -- _victum_, _vincere_ -- _victum_
etc. etc.

Ci adjunte se ancor li desfacilitá totalmen tacet pri li assimilation
del consonantes por ex. _trah-er_ -- _trah-to_ -- _tracto_,
_distinguere_ -- _distincto_, _jungere_ -- _juncto_ etc.

Li desfacilitá pri constant mutation del consonante in _dicer_ -- _dicto_ anc
...
Li nominatives _me_ e _te_ sembla esser repugnant, un casu objectiv es
...
accentu _alíqui, aliquíd, altér, ultér, illúd, idém, nunquám_ etc. e in
general tre mult latin paroles ne va submisser se a ti regul: _juvénes,
homíne, sempér, quamódo, extér, pretér, supér, puéro_.
...
formes ja ne existent in li modern lingues quam p. ex. _acervo_ (amasse),
_sole_ (D _pflegt_) quel coincide con _sole_ (D _Sonne_) e _solo_ (D _allein_), _hom_
{equals} F _on_, _obsequio_ (F _hommage_), _fier_ (D _werden_), suffixe _-ense_
(_Siam-ense_), _post-charta_, etc.

// XXX NOTE: ci esset li marca original de págine -27-

Curios e nelatin sembla nos paroles quam: _mutto_ (parol, F _mot_), _midio_ {equals}
1/2.
...
_-etu_ (L _-etum_) es absolut obsolet e existe solmen in quelc poc paroles,
in omni casu it ne es international.

In li sense de collective nu es quasi international li suffix _-age_,
...
témpores de antiqui latin, p. ex. li radica _manca_ es international til
R{dot} durant que _carenti_ es obsolet parol solmen scientic. Li lingue international ne es
solmen un lingue por scientistes, e deve esser un vivent lingue e ne
basat sur martallia.

Li contrarietá, expresset per du affixes: _des-_ e _anti-_ sembla esser ne
rect preciset.

Es dit, que _anti_ es usat in vocabules ne verbisabil, ples comparar F
_antidater, antidoté_.

Inversmen _des_ sovente es usat che paroles ne verbisiabil p. ex. F
_désastre, désavantage, désharmonie_.
...
_-urio_ sembla ne motivat.

Tre bon es li remarcat qualitá que li suffix _-ia_ local, pos _i_ del radica
contracte se ad _i_ accentuat: _librario-libraria_.

Íncomprensibil es li diferentie inter _-arium_ e _-aria_, _aquarium_ e _aquaria_.

Absolut ínmodern es conservar li _a_ final in _-ista_, _a_ have li idé
international de feminin e ci _a_ final in ti sufixe ha perdit se in li
...
_-ario_ ne sempre significa officie, occupation, function, ples comparar:
millionario, destinatario.

Li suffixe _-ilia_ sembla esser ne motivat; li exemples citat ne es
convictiv.

Interessant es anc li sense de _-eo_ (_igneo, aureo_) {equals} simil in aspectu, in
composition e li juxtaposition apu _-ear_, quel sufixe es prendet just in
...
// XXX TODO marcar:
// https://anno.onb.ac.at/cgi-content/anno-plus?aid=e0g&datum=1927&page=34&size=80
...
Il scri pri _c_: «Ta semblanta naturaleso esas tote superflua e nur
nocoza naturaleso». Ma per ti _nocoza naturaleso_ Occidental deriva
...
bon quam _simpla_. Nu 1) simplic (= sin plic {equals} ohne Falte) es parallel
...
editet un german brochura in 32 págines, con titul _Die Wahrheit über Ido_
...
nomojn. (Ordinare oni scias nur pri 150 ĝis 200 lingvo-projektoj).
...
in F _merci_, D _dank_, A _thank_. Ma _danco_ Esperanto {equals} F _danse_, A
_dance_, IS _danza_, D _tanz_!

Ma in li form _laca_ omni occidentale va creder reconosser li liquide:
A _lac_, S _laca_, I _lacca_, D _lack_. Támen _laca_ Esperanto {equals}
«fatigat» (FSAL)!…
...
scientic e tecnic terminologie tal qual it es, on es fortiat rebaptisar
...
derivates ne es international: _aviadisto, senpere, alcentrigo_ (in
...
_observatorio, produktiva, transformatoro_ (in Occidental ili es
...
Esperanto{blank}footnote:[Li nov introductet _redakcio_ sta exter
grammatical conexe con li radica _redakt_.],
...
per li contextu, p. ex.: _paca kongreso_. Ca to es D _friedlicher Kongreß_ o
_Friedenskongreß_?
...
etc.)footnote:[Ma anc ili ne di _arbaro_, _herbejo_ quam in Esperanto ma
have autonom paroles por ti conceptiones de un propri totalité. Esque
vermen apu «vocabularium» (_vortaro_), _arbaro_ ne vell significar plu bon D
_Baumschule_, F _pépiniére_, I _semenzajo_ quam just un forest? Sr. Teo Jung
in su jurnal «Heroldo de Esperanto» nr. 14 scri pri li paroles
_mal-bona_, _mal-longa_ etc: «En la poezio sin venĝas tiu ŝajna facileco
...
hodie on usa ja in D Abteil vice anteyan Coupé (Abteilung). Do un tal
...
to! On save p. ex. que in German e Dan lingues li substantives es scrit
per majuscules. Nu, chascun quel havet occasion observar infantes e
...
«Esperantaj» _sciigo, senpere, estro, militistara, nepre_ etc. es plu facil
anc por li max ínerudit simplic hom quam _information, ínmediat, chef,
militari, absolut_?
...
asserter que ili nequande va parlar it rect, yo va questionar: quant
...
scriente (nr 6, april 1927, pag. 13): «laŭ la metodojn uzitajn».]
...
marte 1927, sub titul _Rememoraĵoj pri la unua tempo de Esperanto_ O. D.
...
tre dubios que li «Homaranismo» del Esperantistes va esser suficent fort
...
Noi totalmen ne condamna li _fair_ utilitarisme, pensante que sub li
...
discredita li idé del lingue international.
...
Esperanto-prospecte de Steyrermühl-Verlag, Wien, u dr Pfeffer scri: «Esperanto
...
lingues! Li studia de Esperanto have un extrem plu alt valore educativ quam ti
...
Ido. Li sol possibil election es inter Esperanto e Occidental, nam presc li
...
verdar {equals} D _werden_, F _devenir_, contradí al principie III: «un form deve
reciver li comun international signification, ne un altri!» Nu li form
_verd_ es conform al parol F _verg_, A _green_, e ne a D _werden_, quel anc ne
es international. Yo cita ancor quelc altri «international» paroles de
Arulo: _termato, gresar, erastanti, noturizar, arkíatro, arkto_ (ne «arctic»
ma F _étroit_, D _eng_), _axino, barno, bizoniar_ ne parent con _bison_),
_borno_ (ca D _Born_ o F _borne_?), qui save to sin explication, e quel logica
...
general on max aplica hodie in Occidental preliminarimen li facil
...
atinget li maximum possibil. Ne conservante antiquat formes latin _charta_
(paper), _copia_ (abundantie), _equo_ (cavalle) quam Interlingua de prof.
Peano, ni compilante hiperlogic caprioles _savigar da olua registragisto_
...
_klorofilo_ es «chlorophyll» e ne «chlororphil». Li Italian ha tant consumat
...
tande in li laudat Interlingua li auxiliari del preterit _e_ anc es tal,
...
of course, _did_ is used _correctly_ (nor sublineation) only in the
...
_Interlexico del lingue arico-semitic.
Monario-Italiano-Français-English-Deutsch_ de Aldo Lavagnini, Roma 1926.
...
Sembla anc esser paroles negri-somali e tamil p. ex. _ibar_ {equals} comprar. Ma
...
que _xar_ {equals} tsar, _e_ {equals} forsan, _zanho_ {equals} mercur, _zazar_ {equals} agitar, _wienco_ {equals}
scientie, _weptro_ {equals} sceptre, _kamar_ {equals} amar, _udo_ {equals} aqua, etc. …? Li
...
ne existe in german, ni mem quam parol extran, quam p. ex. _skiuren_ por
_Eichhorn_, _handgeben_ por _einhändigen_, _Flösse_ por _Floß_ etc. E paroles
german quam _Konscius_, _vituperieren_ etc. totalmen ne existe. Russ _doroga_
...
de ili _ad libitum_ quo ducte ad absurditás. Sr L. mey assecurar se li
...
poc per print-erras. p. ex.: _abandon_ (D _Verlassung_ ne existe), _abbatar_
(ne D _schlagen_ ma _niederschlagen_, R ne _svalivat'_ ma _nisvergat'_),
_ab-horrar_ (R _imet'_ have li sense «haver». Probabilmen in li lexico ha
esset _imet' otvrashtchenie_ {equals} «haver horrore»!), abjekto (ne es D _niedrig_,
R _nichtójnyi_ ma D _verworfen_, R _gnúsnyi, níski_).

// XXX TODO 2023-04-17: missage misset al gruppe por confirmar li
// accentuation del du russ paroles in li ultim frase in supra.
...
Dr. Zamenhof ha prendet it de D _Kronprinzessin_, quel il transscrit per
_kronprincedzino_, concludente que li finale -edzino have li sense de…
marita, ex quel il derivat li parol _edzo_ por marito, pos
subtraction de _-ino_, sufix por lu feminin.footnote:[Li originari
signification (just conservat in Occidental) del sufix _-in_ es:
descendent, provenient, consistent de… (p. ex. argentin, marin,
alpin, canin, cristallin, serpentin, rubin, maltin, bernhardin, platin
de S _plata_ {equals} argente etc.).] Analog il derivat: _fraŭlo_
(garson) de _fraŭlino_ (garsona e senioretta junt), _kuzo_ (cusino) de
_kuzino_ (cusina)

On ne posse suficentmen admirar ti «logica», memorant a li «antediluvial
scientistes» quel ha explicat li etimologie de A _monkey_ (simio) per
«creatur quel, hant _manqué_ (mancat, fallit) devenir un hom, ha devenit
un simio».

Dr. Zamenhof arbitrari ha attribuet al _-essin_ li signification de
marita. Nam _Prinzessin_ (sam quam _Äbtissin, Diakonissin_ etc.) ne deve
esser maritat, quáncam _Kronprinzessin_ es sempre li marita del _Kronprinz_.
To es li motive pro quel Dr. Zamenhof (con intention o sin) startat de
_Kronprinzessin_. Ex ti ci unic casu, fals interpretat, Dr. Zamenhof deductet li
pseudo-radica _edzo_. Talmen li element ess (quel naturalmen have li
...
Esperanto-paroles _ega_ (grand) e _estro_ (mastro), queles es resultat per
amputation de G _m-ega_ e IS _ma-estro_, e _-ingo_ de D _R-ing_ (annel) por
«portant», p. ex. _kandel-ingo_ (candeliero), _cigar-ingo_ (cigariero).]
...
In «Mondo» nr 7 sr. de Beaufront, li autor de Ido, scri: «_Sintezesez_
esas kontreregula pro ke _sintezar_ ne darfas existar en Ido. _Sintezo_ esas
nomo, ne verbo.» Ho no, sr. de B., secun vor regretat collego Dr.
Couturat, li spiritus rector del Delegation, _sintezo_ have radica verbal
e sintezar existe in Ido, sam quam _analizar, placar_ etc.! Ples consultar
p{dot} ex. li «Kompleta Radikaro Ido-Deutsch», 1919 (composit de F. Schneeberger,
...
editet un propaganda-brochura in sved lingue: _Occidental -- ett
västerländskt kultursprak_ de mag. phil. A. Z. Ramstedt.
...
vider Esperanto-paroles p. ex.: _ĉiam_ (sempre), _kiom_ (quant), _malebleco_
(ínpossibilitá), _saneca_ (sanitari), _kazo_ (casu), _kaso_ (casse), _caro_
(tsar), _patrino_ (matre), _nepre_ (absolutmen), _malbona_ (mal), _mallonga_
(curt), _ege_ (extrem), _boao_ (boa), _firmao_ (firma), _ekspansiebleco_
(expansibilitá), _ekzekuciisto_ (executor), _aerflugisto_ (aviator),
_senarmiliĝo_ (desarmation), _foresto_ (absentie), _colo_ (inch), _fraŭlo_
(garson), _savinto_ (salvator), _menso_ (mente), _ĝardeno_ (jardin),
_ĉirkaŭpolusa_ (circumpolar), _deca_ (decent), _laca_ (fatigat),
_dekoraciisto_ (decorator), _bedaŭrinde_ (regretabil), _ĉeestanta_
(present), _anstataŭ_ (vice).]. Li
...
«y» quam vocale {equals} sved _y_, german _ü_, frances _u_; «y» quam
consonante {equals} _y_ angles, hispan; «c» ante «e», «i», «y» {equals} _ts_, in
omni altri casus {equals} «k»; «g» ante «e», «i», «y» {equals} _j_ frances, in
altri casus quam _g_ german; «h» aspirat quam in angles, german; «q» quam in
german e angles; «s» quam in frances; «v» quam in angles e romanic; «x»
{equals} _ks_; «z» {equals} _ds_; «ch» quam in angles e hispan; «eu» quam in
frances; «n'», «l'» tones molliat {equals} frances _gn_, _ille_, «j» {equals} _j_
angles.

Accentu: Sur li vocale ante li ultim consonante. Li finition de plurale «s» ne
have influentie al accentu. Finitiones «bil, ic {blank}footnote:[Solmen quande
it es pronunciat «ik». Por exemple, li regulari accentu de «felici» es sur li
prim «i». Vide «Complet grammatica de Occidental» de Karl Janotta in
Cosmoglotta serie A, numeró 65 (1929-10). Note del editor digital.], im, ul» es
...
-age:: collective (órdine)
-agie (de verbes):: concretisation del activitá
-al'a:: collective (sin órdine)
-ard:: mal persone
...
// XXX In li originale ci esset note «continuation sur pag III del
// covriment», nam li contiunation esset in li fine del revúe. In
// ti-ci edition ti parte final
// (https://anno.onb.ac.at/cgi-content/anno-plus?aid=e0g&datum=1927&page=83&size=50)
// es movet ci:

// XXX NOTE: ci esset li marca original de págine -76a-
...
// XXX FIXME Ti-ci fotografie ne es ci in li originale, vi
// https://anno.onb.ac.at/cgi-content/anno-plus?aid=e0g&datum=1927&page=56
// https://anno.onb.ac.at/cgi-content/anno-plus?aid=e0g&datum=1927&page=57
// ma quam suplement págine:
// https://anno.onb.ac.at/cgi-content/anno-plus?aid=e0g&datum=1927&page=117&size=45
...
.Edgar de Wahl, li max grand interlinguist vivent, festa li 11 august 1927 su 60-esim die de nascentie.
image::cosmoglotta_1927_p_117.jpg.png.crop.png.q90.jpg["Fotografie de Edgar de Whal in etá de 59 annus, septembre 1926", align="center"]
...
Ja in puerin etá yo havet idé de construction de un lingue. Plen de
...
proque yo ne havet perseverantie in ti cose.

Essente de baltic orígine e vivente li hiverne in Petersburg e li estive
in Estonia, yo ja de puerin etá havet ocasion parlar quar lingues: russ,
...
Rosenberger fat un discurs in li politecnic societé pri li «Mundlingue»
...
yo havet corespondentie con divers persones, ma sin interesse. Li jurnales
...
nave-scoles. Durante ti viages yo havet ocasion anc parlar Esperanto con
...
por me, ma…, anc ci yo havet mal chance. Pos li publication del unesim
...
es sufficent divergent. Si Vu rememora nor corespondentie in anteyan
...
// XXX TODO completar li marcation del paroles in altri lingues per
// cursiv; e paroles in interlingue per signes de citation
...
consequentie del convictiv argumentes exposit de Edgar de Wahl, quam yo self havet
...
international e indicar s fort, p. ex.: casse (Esperanto: _kaso_), casu (_kazo_),
carr (_charo_), car (_kara_).
...
Esperanto-paroles: _radio_ (radio), _firmao_ (firma), _statuo_ (statue), _familio_
(familie).
...
que Esperanto (til cert gradu) es un lingue natural. Li afere támen ne es
dangerosi, nam presc sempre li contextu escarta omni dúbita.
...
existent per su derivates e introducter p. ex. quam Esperanto e Ido: _suno_. To
...
nequande posse abolir omni homonimes, vide p. ex. su radica _bor'_,
significant «forar» e li chimic element «bor», o su nov parol _Paneŭropo_,
quel ne es german _Broteuropa_, ma _Tuteŭropo_.
...
deformationes: _plateno_ (platin), _faruno_ (farine), _pordo_ (porta) etc.
...
etiquettation abominabil quam _emuo_ (emu, nov-seland), _kanguruo_ (cangurú,
austral), _kolibro_ (colibrí, caraíb), _kvago_ (quagga, hottentot), _nadiro_
(nadir, arab), _husaro_ (husar, hungar), _gejŝo_ (geisha, japan), _nirvano_
(nirvana, indic), _edelvejso_ (edelweiss, german).
...
(Esperanto: _haveno_, _pordo_, _sendkostoj_); monstru, (de)monstra(tion) (Esperanto:
_monstro_, _(el)montr(ado)_).
...
Europa, frances, german, angles, anc polones, russ, p.e. _nepre_ (amputat
russ _neprenemo_, Occidental absolut). Do anc Esperanto es quasi solmen un europan lingue
e ne mundo-lingue, quam on sin jure ama asserter contra Occidental. Esperanto have
anc latin radicas quel hodie es totalmen mort p. ex. _ansero_ (Occidental «gans», german
_Gans_, hispan _ganso_, portugales _ganso_, anglesi _goose_, sved _gas_), _sed_ (Occidental «ma», italian _ma_, hispan _mas_, portugales
_mas_, frances _mais_, holandes _maar_, sved _men_), anc grec _kaj_ por Occidental «e(t)», international
per «etc.»

Pri adoption de paroles ex angles on deve esser apartmen caut pro li
grand diferenties inter scrition e pronunciation. Esperanto-paroles _najtingalo_
(angles _nightingale_) e _birdo_ (angles _bird_) monstra manca de unitá in li metode de
adaptation.
...
Per su parolduplettes por un e sam sense (_aviadisto_ e _aerflugisto_,
_delegacio_ e _delegitaro_, _direkcio_ e _direktoraro_, _garnituro_ e _garnaĵo_) it
...
ne-international quam in Esperanto: _hundeca_ (canin), _knabino_ (puella, flicca),
_anstataŭ_ (vice), _bedaŭrinde_ (regretabilmen), es grav misprenses e deve
...
traditional sur it. Li german _Dampfer_ es vapor-nave e ne locomotive, quáncam ti
ci sense forsan vell esser plu proxim. Anc in Esperanto it es tradition que
_vagonaro_ es german _Zug_ e ne _Wagenpark_ (_ĉiuj vagonoj_), logicalmen justificat
per _homaro_ (_ĉiuj homoj_).

Angles, essent un lingue quasi mixtet, have li max mult paroles
hibridic, p. ex. germanic radicas con romanic suffixes: _druncard_,
_drinkable_, _eatable_, _talkative_, _free-lovism_, _backwardation_, _womanize_ etc.
...
romanic lingues e essent afin a angles _war_. _Bell(um)_ vive in «belligerante» e
«bellicoso». Ma it ne posse esser adoptet in li lingue international, pro su confusion con
li adjectiv «bell» (frances _beau_, _belle_, german _schön_), quel es international mult
...
Precipue li preferentie del german (_tago_, _nur_, _bedaŭri_, _ŝajni_), etsi to
...
[quote, Prof. Dr. phil Karl Schüppel, presidente del Esperanto-Societé Parchim]
____
...
[quote, Karl Scheithauer, Leipzig]
____
...
[quote, Magda Hoppstock-Huth, presidente del german section del International Liga de Féminas por Pace e Libertá]
____
Occidental es li unesim lingue international quel on posse subtener.
____

[quote, Prof. Dr. A. L. Guérard, Universitate Stanford, California]
...
[quote, Prof. Dr. Albert Saareste, Universitate Tartu-Dorpat]
____
...
[quote, Anton Fuchs, "forjero (74 annus), Wien"]
...
apertent li porta al total actual real munde scientic, tecnic,
...
vice de lor preterite e _passé défini_.
...
cpr. p. ex. de mettre (metter) -- perf. ind. «j'ai mis», _passé défini_
...
Ido-traduction del fam-conosset brochura de prof. Edward Sapir pri _La
Problemo di Internaciona Linguo Helpanta_. In un curt articul yo ne posse
...
idés de Dr. F. Riedel in su _Principes of de Mundelangue (Uniti Langue)_,
...
diplomizita dal Ido-Akademio» per lor membres F. Schneeberger{nbsp}{cross}, Dr. St.
Liljedahl{nbsp}{cross} e Ing. K. Feder in annu 1921, yo deve protestar contra un
