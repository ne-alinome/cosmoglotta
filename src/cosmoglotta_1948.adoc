...
//
// Last modified 20241111T1555+0100.
...
// XXX REMARK `--` in li fine del verse fa ti-ci combinarse con li
// sequent; `{nbsp}` (ne `{blank}`) evita to, ma in HTML evita anc li
// conversión de `--` to ver strec. Finalmen, li nov creat `{en_dash}`
// es usat.
...
Detra l' fenestre vente torrent e siflant {en_dash}
...
lingvo de l' mondo»: _bedaŭri_, _hundo_, _ŝajni_, _ajn_, _blinda_, e «tutti
