...
//
// Last modified: 20230508T1216+0200.
...
de su valor ínsuperabil {en_dash}
...
politecnicum de Budapest. Hodie il habita Craiova u il have li
...
leven, ferment-pasta, lad de cress, de cicoré, de lattug, de seleri,
...
*Trincages.* -- Fermentat trincage, vin, champagne (parfum del vin), bir, bir-eria,
...
*Condimentes.* -- Ingredient-ie, aroma, oleo, vinagre, sal, spice, pipre, caryofil,
...
*Adjectives:* _Li manjator posse esser:_ affamat, sitios, saturat, voracit
gloton-esc, ebrie; trincut, in-satur-abil, avid. -- _Li alimentes posse
esser:_- bon, mal, rancie, corupt, putrid, old, ínsipid, fad, sin gust,
...
_Li alimentes posse:_ mofar, putrir, putrificar se, des-composir se,
odorar. _Concernent li alimentes, li homes posse:_ suffrer, tolerar,
supportar, digester.

// Li arte versar liquore ex cruches tro plen {{{3
==== Li arte versar liquore ex cruches tro plen

Li dómina ha invitat
...
In Francia. in li 17esim secul, li scoleros del Universitá
...
Li serviette, quel mult citeanes usa chascun die, quel
...
// Quande aparit li furcette? {{{3
==== Quande aparit li furcette?

Li custom manjar per un furcette aparit in
...
Li archeologos attribue al ancian Egiptianes li arte far
...
// Orígine del parol «cocktail» {{{3
==== Orígine del parol «cocktail»

Omnes parla pri _cocktail_ ma solmen
poc persones conosse li orígine de ti expression. Ti parol anglés, quel
significa litteralmen «caude de gallino» (_cock_ -- gallino, _tail_ -- caude)
...
// Un rostate old de 10.000 annus {{{3
==== Un rostate old de 10.000 annus

Un sved directet de professor
...
Li sandwich es conosset del gastronomes desde presc du
...
// Li can in li alimentation {{{3
==== Li can in li alimentation

Desde long, li carne de can intra li
...
// Li conserves alimentari {{{3
==== Li conserves alimentari

In 1804, li parisan cocinero Appert trovat
...
On save que ex du milliardes de homes queles popula nor
...
// Orígine del panes in form de demí-lune {{{3
==== Orígine del panes in form de demí-lune

Li micri panes in form de
...
// J. Denzler: Esperantistic Tolerantie {{{2
...
To quo significa li International Electrotecnic Commission (IEC) por li
...
secretariatus del Tecnic Comités es repartit inter li divers national
...
Tecnic Comités ha tenet sessiones.
...
Li fundation del Tecnic Comité ISA 37 resulta de un proposition del
...
in cert casus usat,  ma specialmen in tecnica, p. ex, tele-vision,
...
// Thomas G. Masaryk {cross} {{{2
=== Thomas G. Masaryk {cross}
