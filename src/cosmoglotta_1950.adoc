...
//
// Last modified: 20230416T1511+0200.
...
hero-a, soci-a (yes, ma Esperanto devet poy adopter nov radicas: social/ist,
...
un conjuntion (ĉu)!!! Li líttere -i have anc plur significationes in
...
adverbie (ĉi), un numerale (tri). To es íntolerabil in un lingue international bon
