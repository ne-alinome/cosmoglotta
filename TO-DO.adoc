...
- Convert long quotes at the end of a paragraph into quotes blocks,
  e.g. "bla bla: «...»".
- Fix "H2O" and others.
- Homogenize "A.P.I.S.", "U.E.A.", "U.S.A.", "C.E.L.I.A." and others,
  without spaces.
...
- Update "illi".
- Fix em dashes after decimal points; also before ":" and others: they
  are not rendered by Asciidoctor.
- Update "mei" -> mi.
- Compact "P. E. N." and others.
- Homogenize "p. e." into "p. ex.", depending on the article.
- Update orthography: systema, appoy, theatre...
- Fix "initial" -> "inicial".
- Expand "cglt", "cgltta", "cglta".
